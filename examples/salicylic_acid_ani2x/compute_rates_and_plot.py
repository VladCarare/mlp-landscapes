...
# # titles = ['GFN2-xTB*','ANI2x','AIMNet2*','Allegro','MACE','NequIP','MACE-MP-0b3*','SO3LR*']
# # calc_types = ['retrain','altitude']
# models = ['ani2x']
# titles = ['ANI2x']
# calc_types = ['retrain']
...
# fig, axs = plt.subplots(1,2, figsize=(10,4), dpi=100, gridspec_kw={'wspace':0.23},sharex=True,sharey=False)
# ax, ax2 = axs[0], axs[1]
...
#                 # try:
#                 print(pathway_to_test, model, calc_type)
#                 mfpt1=[]
#                 variance=[]
...
#                 points_isolated_pathway[f'{color_label} {display_labels[model_idx]}'] = mfpt1_ratio
# except:
...
#                 color = model_colors_dict[color_label][model],label=display_labels[model_idx] + f' {plot_label}', zorder=zorder)
#                 points_pathway_within_ktn[f'{color_label} {display_labels[model_idx]}'] = mfpt1_ratio
# except:
