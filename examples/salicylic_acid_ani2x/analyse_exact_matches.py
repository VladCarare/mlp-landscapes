...
It quantifies differences in structure and energy between exact minima and transition states pairs.
...
if __name__=='__main__':
    ...
    minima_correspondences = comparison.find_minima_correspondences()
